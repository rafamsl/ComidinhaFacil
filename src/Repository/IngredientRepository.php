...
class IngredientRepository extends ServiceEntityRepository
{
    ...
    public function buildFromDTO(IngredientsDto $ingredientsDto): Ingredient
    {
        $newIngredient = new Ingredient();
        $newIngredient->setName($ingredientsDto->getName());
        $newIngredient->setUnit($ingredientsDto->getUnit());
        $this->getEntityManager()->persist($newIngredient);
        $this->getEntityManager()->flush();
